<%@page import="com.example.lab103.Dtos.SalarioPorDepartamentoDto" %>
<%@page import="com.example.lab103.Dtos.EmpleadosPorRegionDto" %>
<%@page contentType="text/html" pageEncoding="UTF-8" %>
<jsp:useBean id="listaEmpleadPorRegion" type="java.util.ArrayList<com.example.lab103.Dtos.EmpleadosPorRegionDto>"
             scope="request"/>
<jsp:useBean id="listaSalarioPorDepa" type="java.util.ArrayList<com.example.lab103.Dtos.SalarioPorDepartamentoDto>"
             scope="request"/>
<!DOCTYPE html>
<html>
    <head>
